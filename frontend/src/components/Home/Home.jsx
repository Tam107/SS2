...
const Home = ({ title, setTitle, full, setFull, content, setContent,showRequest,setShowRequest }) => {
  ...
  return (
    <>
...

      {
        showRequest && (
          <>
            <PopUpRequest data={user.EssaysId} showRequest={showRequest} setShowRequest={setShowRequest}/>
