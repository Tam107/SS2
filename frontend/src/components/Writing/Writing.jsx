...
const Writing = ({ full, setFull, data }) => {
  ...
  return (
    <div className="relative w-full h-screen pl-28 pr-4 py-4 bg-[#F6F5F1]">
      ...
      <div className="popup fixed top-[10%] right-0 w-[2%] bg-white px-2 py-4 h-80 rounded-tl-xl rounded-bl-xl shadow-lg transition-all duration-300 hover:w-[10%]"></div>
      <div className="flex w-full gap-1">
        ...
        >
          {!full && (
            <>
              <div className={`w-full duration-300 transition-all px-2 py-2 `}>
